    ...
    <div className='flex flex-row w-full min-h-screen bg-[var(--Treasureana---Geocaching-App-11)]'>
      ...
      <div className='w-1/2 min-h-screen flex items-center justify-center p-8'>
        <div className='max-w-md w-full'>
          <div className='mb-10'>
            <h2 className='text-3xl font-bold mb-2 text-[var(--Treasureana---Geocaching-App-8)] font-Funnel_Display'>Welcome Back</h2>
            <p className='text-[var(--Treasureana---Geocaching-App-9)] font-Funnel_Display'>Sign in to your account</p>
          </div>
          ...
          <form className='space-y-6'>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center'>
                ...
                />
                <label htmlFor='remember-me' className='ml-2 block text-sm text-[var(--Treasureana---Geocaching-App-8)] font-Funnel_Display'>Remember me</label>
              </div>
      ...
      <div className='relative w-1/2 min-h-screen'>
        ...
        <div className='flex flex-col relative z-10 gap-10 items-center justify-center h-full'>
          ...
          <p className='font-Funnel_Display text-[var(--Treasureana---Geocaching-App-6)] text-lg text-center px-12'>To keep connect with us please login with your personal informations by email address and password</p>
        </div>
      </div>
    </div>
  );
